...
pub use validate_domain::ValidateDomainRequest;
pub use validate_domain::ValidateDomainResponse;
mod get_domain_name;
...
mod get_domain_derived_predicate_details;
pub use get_domain_derived_predicate_details::GetDomainDerivedPredicateDetails;
pub use get_domain_derived_predicate_details::GetDomainDerivedPredicateDetailsRequest;
pub use get_domain_derived_predicate_details::GetDomainDerivedPredicateDetailsResponse;
